    ...
    for (int j=0; j<6;j++)
        {
            ...
            circulos(d,sqrt(15.95),3,3,0,2*M_PI,5,blanco,3,3);
    ...
    for (int j=0; j<6;j++)
        {
            ...
            circulos(b,3,3,3,0,2*M_PI,5,blanco,3,3);
            circulos(b,3,2,3,0,2*M_PI,5,negro,3,3);
        }

    circulos(a,4.5,3,3,0,2*M_PI,1,blanco,3,3);
    circulos(a,4.5,2,3,0,2*M_PI,1,negro,3,3);

    circulos(a,2.5,3,3,0,2*M_PI,1,blanco,3,3);
